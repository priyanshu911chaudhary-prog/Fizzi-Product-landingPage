...
export async function loadTextures() {
    ...
    const tablePaths = [
        '/textures/table/wood_table_diff_8k.jpg',
        '/textures/table/wood_table_nor_gl_8k.jpg',
        '/textures/table/wood_table_arm_8k.jpg',
    ];

    const fabricPaths = [
        '/textures/mate/fabric_pattern_05_col_01_8k.jpg',
        '/textures/mate/fabric_pattern_05_nor_gl_8k.jpg',
        '/textures/mate/fabric_pattern_05_rough_8k.jpg',
    ];
